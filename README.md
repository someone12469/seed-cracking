Targets Minecraft 26.1.2. JARs available on [GitHub Releases](https://github.com/someone12469/seed-cracking/releases/latest) and temporarily on GitHub Actions.
